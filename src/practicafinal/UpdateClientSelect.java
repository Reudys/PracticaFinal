 ...
 * @author Ana Pèrez
 */
public class UpdateClientSelect extends javax.swing.JFrame {
    ...
    public void conectar() throws SQLException {
        ...
        if (con != null) {
            ...
            if (!textUser.isEmpty()) {
                ...
                if (searchUser(textUser)) {
                        UpdateClient open = new UpdateClient();
                        open.setVisible(true);
                        dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Error, no se encontro al usuario");
                }
            } else {
    ...
    public boolean searchUser(String textUser) throws SQLException {
        // Corregir la consulta SQL
        String query = "SELECT COUNT(*) FROM client WHERE user_name = ?";
    ...
    /**
     * Creates new form UpdateClientSelect
     */
    public UpdateClientSelect() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(userText, javax.swing.GroupLayout.PREFERRED_SIZE, 305, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateClientSelect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateClientSelect().setVisible(true);
            }
        });
    }
